:source $VIM\vimfiles\syntax\cppSYSTEMCALL.vim "just for MSWIN
...
syn keyword cppSTL 		advance basic_string bidirectional_iterator bidirectional_iterator_tag binary_function bind1st bit_vector char_producer char_traits char_type distance distance_type equal_to forward_iterator forward_iterator_tag front_inserter hash identity input_iterator input_iterator_tag insert_iterator int_type istream_type istreambuf_iterator iterator_traits make_pair mem_fun1_ref_t mem_fun1_t mem_fun_ref_t mem_fun_t not_equal_to ostreambuf_iterator output_iterator output_iterator_tag priority_queue project1st project2nd queue random_access_iterator random_access_iterator_tag raw_storage_iterator release reverse_bidirectional_iterator rope select1st select2nd sequence_buffer slist stack streambuf_type subtractive_rng unary_function
